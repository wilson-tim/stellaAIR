create or replace PROCEDURE        sp_l_air_tickets_test (fileToProcess VARCHAR2) AUTHID CURRENT_USER AS 
-- DECLARE /*****  D E C L A R E  S E C T I O N  *****/
--===========================================================
-- sp_l_air_tickets - which takes the contents of AIR files
-- and populates the ticket table
--
-- Version of code for testing and debuggin purposes
--
--===========================================================
-- Change History
--===========================================================
...
v_code                    NUMBER(5);
v_emd_found               NUMBER:=0;
v_endfile_found           NUMBER:=0;
...
v_insert_passenger        BOOLEAN:=False;
...
v_num_conj_tkts           NUMBER:=0;
v_num_emd_docs            NUMBER:=0;
v_num_exchconj_tkts       NUMBER:=0;
...
v_ubpos                   NUMBER;
v_unpaid_tax_found        BOOLEAN:=False;
